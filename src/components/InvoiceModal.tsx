export default function InvoiceModal({ open, onClose, booking }: any) {
  if (!open) return null;
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "flex-end", zIndex: 999 }}>
      <div style={{ background: "#fff", width: "100%", borderRadius: "20px 20px 0 0", padding: 24 }}>
        <p style={{ fontWeight: 700, marginBottom: 8 }}>Invoice</p>
        <p style={{ color: "#6B7280", fontSize: 14, marginBottom: 16 }}>Amount: P{booking?.offer}</p>
