        ...
        {vehicle && (
          <div className="bg-white/10 rounded-2xl p-4">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-xl bg-[#F97316]/20 flex items-center justify-center">
              ...
              <div className="text-right">
                ...
                <p className="font-extrabold text-[#F97316]">P{vehicle.deposit_balance || 0}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="p-4 pb-24 space-y-3">
        ...
        {isPreferred && (
          <div className="flex items-center gap-3 bg-[#FFFBEB] border border-[#D97706]/20 rounded-2xl px-4 py-3">
            <Star className="h-5 w-5 fill-[#F97316] text-[#F97316] shrink-0" />
            <div>
              <p className="text-sm font-bold text-[#0F0F0F]">Preferred Driver</p>
